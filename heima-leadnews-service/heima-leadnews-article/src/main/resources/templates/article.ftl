...
<head>
    ...
    <title>黑马头条</title>
    <!-- 引入样式文件 -->
    <link rel="stylesheet" href="../../../plugins/css/lf9-cdn-tos.bytecdntp.com_cdn_expire-1-M_vant_2.12.20_index.min.css">
    <!-- 页面样式 -->
...
<script src="../../../plugins/js/lf9-cdn-tos.bytecdntp.com_cdn_expire-1-M_vant_2.12.20_vant.min.js"></script>
